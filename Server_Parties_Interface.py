...
class interface:
    ...
    def my_print(self):
        for party in self.parties:
            ...
            for i in range(len(party.ToolsForkPPDERT.SSA_self)):
                print(party.ToolsForkPPDERT.SSA_self[i])
            for i in range(len(party.ToolsForkPPDERT.SSA_others)):
                print(party.ToolsForkPPDERT.SSA_others[i])
            print("====================")
